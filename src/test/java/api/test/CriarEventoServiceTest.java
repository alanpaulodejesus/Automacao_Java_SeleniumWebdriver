...
import static utils.Generator.dateFuture;
...
public class CriarEventoServiceTest {
    ...
    public void deveCriarEventoServiceComSucesso() throws Exception {
        response = eventoService.criarEvento( "Evento " +Generator.firstName, "Descricao" +Generator.firstName, dateFuture);
        ...
        Assert.assertEquals(dateFuture, dataRetornado);
    }
